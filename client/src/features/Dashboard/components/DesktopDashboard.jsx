      ...
      <div className="flex-1 overflow-auto">
        <div className="">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div
              className={`flex items-center space-x-2  rounded-lg p-1 text-sm font-medium ${
                dark ? "bg-[#363636] text-gray-200" : "bg-gray-100"
              }`}
            >
              {/* Status Dropdown */}
              <div className="relative">
                ...
                {isStatusOpen && (
                  <div
                    className={`absolute left-0 mt-2 w-48  rounded-md shadow-lg py-1 z-10 ${
                      dark ? "bg-[#363636]" : "bg-white"
                    }`}
                  >
              ...
              <div className="relative">
                <button
                  ...
                  className={` py-2 px-4 rounded-lg flex items-center justify-between w-40 ${
