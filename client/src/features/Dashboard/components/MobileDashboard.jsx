...
const MobileDashboard = () => {
  ...
  return (
    <div
      className={`flex flex-col w-full min-h-screen   relative overflow-x-hidden -mt-5 ${dark ? "bg-[#121212] text-gray-200" : "bg-white text-gray-800"
        }`}
    >
      <main className=" space-y-7">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            className={` border-[1.5px] p-2 rounded-lg border-zinc-300 flex items-center space-x-2 text-sm ${dark ? "text-gray-200" : "text-gray-600"
              }`}
          >
        ...
        <div>
          <div className="flex justify-between items-center mb-7">
            <div className="flex items-center space-x-3">
              <div
                className={`p-2  rounded-full ${dark ? "bg-[#B4DA00]" : "bg-[#EAF6DA]"
                  }`}
              >
                <RefreshCw
                  size={20}
            ...
            <button
              className={`flex items-center text-sm font-semibold  ${dark ? "text-gray-300" : "text-gray-500"
                }`}
            >
              <span>View All</span>
          ...
          <div className="space-y-7">
            {onGoingProjects.map((p) => (
              <div
                key={p.id}
                className={`p-4 border rounded-3xl shadow-[0_4px_16px_rgba(0,0,0,0.05)] space-y-3  ${dark
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-full rounded-full h-1.5 ${dark ? "bg-gray-700" : "bg-gray-200"
                      } `}
                  >
                    <div
        ...
        <div>
          ...
          <div
            className={` p-6 rounded-3xl border shadow-[0_4px_16px_rgba(0,0,0,0.05)] ${dark
                ? "bg-[#252525] border-gray-500 hover:bg-[#2A2A2A]"
                : "bg-white border-gray-100 hover:bg-gray-50"
              }`}
          >
